  ...
  return (
    <main className="pt-40 pb-32 px-6 md:px-12 max-w-4xl mx-auto w-full font-data text-sm leading-relaxed text-dark/80">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">Who we are</h2>
          <p>Our website address is: https://rivana-automations.com.</p>
        </section>

        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">Comments</h2>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">Media</h2>
          <p>If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p>
        </section>

        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">Cookies</h2>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">Embedded content from other websites</h2>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">Who we share your data with</h2>
          <p>If you request a password reset, your IP address will be included in the reset email.</p>
        </section>

        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">How long we retain your data</h2>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">What rights you have over your data</h2>
          <p>If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p>
        </section>

        <section>
          <h2 className="font-heading font-bold text-2xl uppercase tracking-tight mb-4 text-dark">Where your data is sent</h2>
